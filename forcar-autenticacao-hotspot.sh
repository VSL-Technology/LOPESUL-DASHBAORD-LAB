...
sshpass -p "$MIKROTIK_PASS_VAR" ssh -o StrictHostKeyChecking=no "$MIKROTIK_USER_VAR"@$MIKROTIK << EOF
...
sshpass -p "$MIKROTIK_PASS_VAR" ssh -o StrictHostKeyChecking=no "$MIKROTIK_USER_VAR"@$MIKROTIK \
