...
/user add name=<MIKROTIK_USER> password=<MIKROTIK_PASS> group=full comment="API user for VPS relay"
...
:put ""
:put "Credenciais API (definir no .env):"
:put "  - User: <MIKROTIK_USER>"
:put "  - Pass: <MIKROTIK_PASS>"
:put "  - Host: <MIKROTIK_HOST>"
:put "  - Port: <MIKROTIK_PORT>"
