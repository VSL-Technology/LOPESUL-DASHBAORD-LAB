...
- **Usuário API**: definido em `MIKROTIK_USER` no `.env`
- **Senha API**: definida em `MIKROTIK_PASS` no `.env`
- **Porta API**: `8728`
...
- **Database**: `railway`
- **User**: `postgres`
- **Password**: definido apenas no `.env`
- **Connection String**: apontar `DATABASE_URL` no `.env` (não documentar valor real)
...
**Arquivo**: `/opt/painel-new/.env` (preencher apenas no arquivo, não em docs)
```env
NODE_ENV=production
PORT=3000
DATABASE_URL="<preencher-no-.env>"
JWT_SECRET="<preencher-no-.env>"
APP_URL="https://painel.lopesuldashboardwifi.com"
PAGARME_SECRET_KEY="<preencher-no-.env>"
MIKROTIK_HOST="<preencher-no-.env>"
MIKROTIK_USER="<preencher-no-.env>"
MIKROTIK_PASS="<preencher-no-.env>"
MIKROTIK_PORT="<preencher-no-.env>"
MIKROTIK_SSL=0
MIKROTIK_TIMEOUT_MS=8000
RELAY_URL="<preencher-no-.env>"
RELAY_TOKEN="<preencher-no-.env>"
```
...
**Arquivo**: `/root/mikrotik-relay/.env` (preencher apenas no arquivo, não em docs)
```env
PORT=3001
INTERVAL=15000
RELAY_TOKEN="<preencher-no-.env>"
TOKEN="<preencher-no-.env>"
CORS_ORIGINS="https://painel.lopesuldashboardwifi.com/dashboard,https://cativo.lopesuldashboardwifi.com/pagamento.html"
MIK_LIST="mkt01@<HOST>@<USER>@<PASS>,mkt02@<HOST>@<USER>@<PASS>"
MKT_PORT=8728
MIKROTIK_HOST="<preencher-no-.env>"
MIKROTIK_USER="<preencher-no-.env>"
MIKROTIK_PASS="<preencher-no-.env>"
