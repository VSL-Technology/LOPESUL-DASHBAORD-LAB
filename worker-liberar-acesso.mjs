...
import { validateRelayUrlWithToString } from './src/lib/config/relayUrlValidator.js';
...
const RELAY_URL_RAW = process.env.RELAY_URL || process.env.RELAY_BASE || 'http://localhost:3001';
const RELAY_URL = validateRelayUrlWithToString(RELAY_URL_RAW);
