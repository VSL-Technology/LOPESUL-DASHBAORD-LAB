// src/lib/pagarme.js
/* global createOrder, createCardPayment */
...
async function coreFetch(path, { method = 'GET', headers = {}, body } = {}) {
  // Segurança: não permitimos URLs absolutas arbitárias; apenas caminhos relativos ao BASE.
  if (path.startsWith('http')) {
    throw new Error('coreFetch: absolute URLs are not allowed');
  }

  // normaliza o path (evita // e garante prefixo /)
