    ...
    <>
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto px-2 lg:px-4 pt-4 lg:pt-6 pb-3 lg:pb-4">
          <div className="mb-4 rounded-xl border border-white/15 bg-white/5 px-3 py-3 text-sm text-white">
        ...
        >
          <div className="flex gap-2">
            <button
              ...
              className="flex-1 rounded-lg border border-white/15 px-3 py-2 flex items-center justify-center text-lg"
            ...
            <button
              ...
              className="
                flex-1 flex items-center gap-3 rounded-lg font-semibold
